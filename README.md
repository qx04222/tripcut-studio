...
<p align="center"><strong>v0.9.0：像剪映一样上手、更像一个 Mac 软件的旅拍精选工作台</strong> —— 四步流水线：导入 → 挑选 → 排列 → 导出，顶栏永远告诉你下一步点哪里，键位与设置都按剪映的习惯来。</p>

<p align="center">
  <a href="https://github.com/qx04222/tripcut-studio/releases/tag/v0.9.0">下载 v0.9.0</a>
  · <a href="docs/USER_GUIDE.md">用户指南</a>
  · <a href="docs/releases/v0.9.0.md">版本说明</a>
  · <a href="docs/design/design-system.md">设计系统</a>
  · <a href="CONTRIBUTING.md">参与贡献</a>
</p>

<p align="center">
  <img alt="Release v0.9.0" src="https://img.shields.io/badge/preview-v0.9.0-f4a261?style=flat-square">
...
> [!IMPORTANT]
> v0.9.0 是面向测试者的 Apple Silicon 未签名预览版，使用 ad-hoc 签名，尚未经过 Apple Developer ID 签名与公证。请从本仓库 Release 下载、核对 SHA-256，并使用有独立备份的素材测试；首次启动如遇 Gatekeeper 拦截，右键点击应用图标选择「打开」即可。
>
> 本版 DMG：[`TripCut-Studio_0.9.0_github-preview-v0.9.0-20260915T0102Z_preview_aarch64.dmg`](https://github.com/qx04222/tripcut-studio/releases/download/v0.9.0/TripCut-Studio_0.9.0_github-preview-v0.9.0-20260915T0102Z_preview_aarch64.dmg)，SHA-256 `4574bbaf777f6e8c6113fadcab3e9531fba252eacf9139106ec585d9a7f927b4`。
>
...
> 完整说明见 [v0.9.0](docs/releases/v0.9.0.md) / [v0.8.4](docs/releases/v0.8.4.md) / [v0.8.3](docs/releases/v0.8.3.md) / [v0.8.2](docs/releases/v0.8.2.md) / [v0.8.1](docs/releases/v0.8.1.md) / [v0.8.0](docs/releases/v0.8.0.md) 更新说明。
...
1. 前往 [v0.9.0 Release](https://github.com/qx04222/tripcut-studio/releases/tag/v0.9.0)，下载 [`TripCut-Studio_0.9.0_github-preview-v0.9.0-20260915T0102Z_preview_aarch64.dmg`](https://github.com/qx04222/tripcut-studio/releases/download/v0.9.0/TripCut-Studio_0.9.0_github-preview-v0.9.0-20260915T0102Z_preview_aarch64.dmg)；
