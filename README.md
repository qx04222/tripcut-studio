...
<p align="center"><strong>v0.7.0：像剪映一样上手的旅拍精选工作台</strong> —— 四步流水线：导入 → 挑选 → 排列 → 导出，顶栏永远告诉你下一步点哪里，键位与设置都按剪映的习惯来。</p>

<p align="center">
  <a href="https://github.com/qx04222/tripcut-studio/releases/tag/v0.7.0">下载 v0.7.0</a>
  · <a href="docs/USER_GUIDE.md">用户指南</a>
  · <a href="docs/releases/v0.7.0.md">版本说明</a>
  · <a href="docs/design/design-system.md">设计系统</a>
  · <a href="CONTRIBUTING.md">参与贡献</a>
</p>

<p align="center">
  <img alt="Release v0.7.0" src="https://img.shields.io/badge/preview-v0.7.0-f4a261?style=flat-square">
...
> [!IMPORTANT]
> v0.7.0 是面向测试者的 Apple Silicon 未签名预览版，使用 ad-hoc 签名，尚未经过 Apple Developer ID 签名与公证。请从本仓库 Release 下载、核对 SHA-256，并使用有独立备份的素材测试；首次启动如遇 Gatekeeper 拦截，右键点击应用图标选择「打开」即可。
>
> 本版 DMG：[`TripCut-Studio_0.7.0_github-preview-v0.7.0-20260914T0544Z_preview_aarch64.dmg`](https://github.com/qx04222/tripcut-studio/releases/download/v0.7.0/TripCut-Studio_0.7.0_github-preview-v0.7.0-20260914T0544Z_preview_aarch64.dmg)，SHA-256 `5b5ddc6a9282027654f1abe9c850c77d36d0d37a00ab35abc04c95a29c3ca747`。
>
...
设置页「关于 → 检查更新」可发现新版本并下载安装，安装包会做 minisign 签名校验；已安装 0.3.0 / 0.5.0 的用户可直接应用内更新到 0.7.0；未签名的预览版仍可能被 Gatekeeper 拦截，请按提示核对来源后放行。

## 下载与第一次使用

1. 前往 [v0.7.0 Release](https://github.com/qx04222/tripcut-studio/releases/tag/v0.7.0)，下载 [`TripCut-Studio_0.7.0_github-preview-v0.7.0-20260914T0544Z_preview_aarch64.dmg`](https://github.com/qx04222/tripcut-studio/releases/download/v0.7.0/TripCut-Studio_0.7.0_github-preview-v0.7.0-20260914T0544Z_preview_aarch64.dmg)；
2. 同时下载 `SHA256SUMS.txt`，核对 DMG 的 SHA-256 为 `5b5ddc6a9282027654f1abe9c850c77d36d0d37a00ab35abc04c95a29c3ca747`；
