...
<p align="center"><strong>v0.10.1：挑完告诉你为什么、一句话挑片、模型一键安装</strong> —— 自动挑选后右侧滑出「为什么是这些」，每段一句白话理由，不要 / 换一段 / 全部撤销；写一句「挑 60 秒，风景为主」就出一版，首页三句现成的；画面理解 / 转写模型在设置里一键后台安装；主题三档、深色打磨。</p>

<p align="center">
  <a href="https://github.com/qx04222/tripcut-studio/releases/tag/v0.10.1">下载 v0.10.1</a>
  · <a href="docs/USER_GUIDE.md">用户指南</a>
  · <a href="docs/releases/v0.10.1.md">版本说明</a>
  · <a href="docs/design/design-system.md">设计系统</a>
  · <a href="CONTRIBUTING.md">参与贡献</a>
</p>

<p align="center">
  <img alt="Release v0.10.1" src="https://img.shields.io/badge/preview-v0.10.1-f4a261?style=flat-square">
...
> [!IMPORTANT]
> **被拦截时这样做**（v0.10.1 是未签名的 Apple Silicon 预览版，第一次打开 macOS 会拦一下，这是正常的）：
> 1. 打开 DMG，把「旅剪工作台」拖进「应用程序」；
> 2. 在「应用程序」里**右键点击**旅剪工作台 → 选「打开」；
> 3. 弹出的对话框再点一次「打开」。之后就和普通软件一样双击启动。
>
> 本版 DMG：[`TripCut-Studio_0.10.1_github-preview-v0.10.1-20260919T1535Z_preview_aarch64.dmg`](https://github.com/qx04222/tripcut-studio/releases/download/v0.10.1/TripCut-Studio_0.10.1_github-preview-v0.10.1-20260919T1535Z_preview_aarch64.dmg)。请用有独立备份的素材测试；不要关闭 Gatekeeper，也不要运行来源不明的解除隔离命令。
>
> <details><summary>想核对下载没被改过（可选）</summary>
>
> 同时下载 `SHA256SUMS.txt`，DMG 的 SHA-256 应为 `075f6124046ca117fa1ae4cac1be2f8184cc0b607cf7bff570e3667403927476`。ad-hoc 签名与 Gatekeeper 的完整说明见[未签名预览版说明](docs/UNSIGNED_PREVIEW.md)。
> </details>
>
...
> 完整说明见 [v0.10.1](docs/releases/v0.10.1.md) / [v0.10.0](docs/releases/v0.10.0.md) / [v0.9.1](docs/releases/v0.9.1.md) / [v0.9.0](docs/releases/v0.9.0.md) / [v0.8.4](docs/releases/v0.8.4.md) / [v0.8.3](docs/releases/v0.8.3.md) / [v0.8.2](docs/releases/v0.8.2.md) / [v0.8.1](docs/releases/v0.8.1.md) / [v0.8.0](docs/releases/v0.8.0.md) 更新说明。
...
1. 前往 [v0.10.1 Release](https://github.com/qx04222/tripcut-studio/releases/tag/v0.10.1)，下载 [`TripCut-Studio_0.10.1_github-preview-v0.10.1-20260919T1535Z_preview_aarch64.dmg`](https://github.com/qx04222/tripcut-studio/releases/download/v0.10.1/TripCut-Studio_0.10.1_github-preview-v0.10.1-20260919T1535Z_preview_aarch64.dmg)，打开 DMG，把“旅剪工作台”拖入「应用程序」；
...
同时下载 `SHA256SUMS.txt`，核对 DMG 的 SHA-256 为 `075f6124046ca117fa1ae4cac1be2f8184cc0b607cf7bff570e3667403927476`。完整安全边界见[未签名预览版说明](docs/UNSIGNED_PREVIEW.md)。不要关闭 Gatekeeper，也不要运行来源不明的解除隔离命令。
</details>
